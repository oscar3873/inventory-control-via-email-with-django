...
class Producto(models.Model):
    ...
    codStock = models.CharField('Codigo de Bulto',max_length=13,help_text="Codigo que figura en el bulto ",blank=True) # LOS FARDOS EN GRAL CONTIENEN UN CODIGO DEL MISMO
